...
| --- | --- | --- | --- |
| [`pragmatic`](./plugins/pragmatic) | Bundle of all pragmatic-skills. Currently includes: muchotexto, vault-session, mobile autoship, verify-to-e2e, macos-screen-recorder, and xquik-x-data. | Claude Code | `bundle` `skills` |
