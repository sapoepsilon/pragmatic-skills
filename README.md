...
| --- | --- | --- | --- |
| [`pragmatic`](./plugins/pragmatic) | Bundle of all pragmatic-skills. Currently includes: muchotexto, vault-session (resume + save), mobile autoship, verify-to-e2e, macos-screen-recorder, loopcopy, review-fix-loop. | Claude Code | `bundle` `skills` |
