...
| [macos-screen-recorder](../macos-screen-recorder) | Privacy-safe macOS QA capture through an Aqua-session LaunchAgent, with signed-install checks, visual review, user-owned uploads, and desktop restoration. |
